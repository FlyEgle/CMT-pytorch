...
from model.Transformers.swin_transformers.models.swin_transformer import SwinTransformer, SwinTransformerFeatures
from model.Transformers.swin_transformers.models.swin_mlp import SwinMLP


def build_model_features(config):
