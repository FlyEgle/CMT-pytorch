...
class ImageDataset(Dataset):
    def __init__(self,
        ...
        Args:
            ...
            train_phase (bool) : train or eval mode 
            input_size  (int)  : resize size 
            crop_size   (int)  : crop size 
            shuffle     (bool) : shuffle or use the origin order
            interpolation (str): 'bilinear' , 'nearst' , 'bicbic' or 'random' default is 'bilinear'
            auto_augment  (str): 'original', 'rand', 'automix' or None
            color_prob  (float):  None or prob for colorjitter 
            hflip_prob (float)  : prob for horizional flip
            vflip_prob (float)  : prob for vertical   flip
        Returns:
            dataset
        """
        ...
        self.colorjitter_prob = None if color_prob is None else (
            color_prob, )*3
